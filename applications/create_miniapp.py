    ...
    for root, dirs, files in os.walk(skeleton_root):
        ...
        for each_dir in dirs:
            if os.path.islink(root + "/" + each_dir):
                ...
                newdir = replace_keep_case(
                    skeleton_word, miniapp_var, each_dir
                )
        ...
        for each_file in files:
            ...
            if re.search(r"\.nc", each_file):
                ...
                for line in f_in.readlines():
                    f_out.write(
                        replace_keep_case(skeleton_word, miniapp_var, line)
                    )
                # Close the files
                f_out.close()
                f_in.close()
...
instances of 'skeleton' with the input 'name'."""
    ...
    PARSER.add_argument(
        ...
        help="""Directory in which the applications are stored.
