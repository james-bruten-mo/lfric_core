...
! vertices on each face - anticlockwise ordering
  vert_on_face(1,:) = (/ 1, 4, 8, 5 /)
  vert_on_face(2,:) = (/ 1, 2, 6, 5 /)
  vert_on_face(3,:) = (/ 2, 3, 7, 6 /)
  vert_on_face(4,:) = (/ 3, 4, 8, 7 /)
...
! Edges on each face
  edge_on_face(1,:) = (/ 1, 5 , 9 , 8  /)
  edge_on_face(2,:) = (/ 2, 6 , 10, 6  /)
  edge_on_face(3,:) = (/ 3, 7 , 11, 6  /)
  edge_on_face(4,:) = (/ 4, 7 , 12, 8  /)
  edge_on_face(5,:) = (/ 1, 2 , 3 , 4  /)
  edge_on_face(6,:) = (/ 9, 10, 11, 12 /)

! Edges on each vertex
  edge_on_vert(1,:) = (/ 1,  2,  5 /)
  edge_on_vert(2,:) = (/ 2,  3,  6 /)
  edge_on_vert(3,:) = (/ 3,  4,  7 /)
  edge_on_vert(4,:) = (/ 4,  1,  8 /)
  edge_on_vert(5,:) = (/ 5,  9, 10 /)
  edge_on_vert(6,:) = (/ 6, 10, 11 /)
  edge_on_vert(7,:) = (/ 7, 11, 12 /)
  edge_on_vert(8,:) = (/ 8, 12,  9 /)
...
! outward unit normal vector to each face  
  normal_to_face(1,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
  normal_to_face(2,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
  normal_to_face(3,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
  normal_to_face(4,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
...
! convention is that vector points along edge in positive xi direction 
  tangent_to_edge(1 ,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
  tangent_to_edge(2 ,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
  tangent_to_edge(3 ,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
  tangent_to_edge(4 ,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
  ...
  tangent_to_edge(9 ,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
  tangent_to_edge(10,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
  tangent_to_edge(11,:) = (/  0.0_r_def,  1.0_r_def,  0.0_r_def /)
  tangent_to_edge(12,:) = (/  1.0_r_def,  0.0_r_def,  0.0_r_def /)
