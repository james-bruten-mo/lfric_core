...
use argument_mod,            only : arg_type, &          ! the type
                                    gh_read, gh_inc, w0, w2, w3, fe, cells ! the enums
...
!! @param[in] ndf_w0 The number of degrees of freedom per cell for w3
!! @param[in] map_w0 Integer array holding the dofmap for the cell at the base of the column for w3
...
subroutine rtheta_code(nlayers,ndf_w0, map_w0, w0_basis, gq, r_theta,          &
  ...
  real(kind=r_def), intent(in) :: chi_1(*), chi_2(*), chi_3(*), u(*), chi_w3_3(*)
