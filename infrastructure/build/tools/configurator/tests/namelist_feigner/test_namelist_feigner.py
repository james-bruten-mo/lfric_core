...
class TestFeigner:
    ...
    def test_computed(self, tmp_path: Path):  # pylint: disable=no-self-use
        ...
        simple.add_computed(
            "biscuits", "integer", "teapot + cheese", "default"
        )
    ...
    def test_everything(self, tmp_path: Path):  # pylint: disable=no-self-use
        ...
        everything.add_computed(
            "yarn", "real", "fish * wibble / 180.0_r_def", "default"
        )
        everything.add_value("tail", "integer", "default")
        everything.add_value(
            "school", "integer", configure_kind="default", bounds="2"
        )
        everything.add_value(
            "hanger", "integer", configure_kind="default", bounds="tail"
        )
        everything.add_string(
            "knife", configure_string_length="filename", bounds="tail"
        )
