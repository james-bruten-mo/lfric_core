...
public :: prolong_masked_kernel_code
  ...
  interface prolong_masked_kernel_code
    module procedure  &
      prolong_masked_kernel_code_r_single, &
      prolong_masked_kernel_code_r_double
  end interface
...
contains
  ...
  ! R_SINGLE PRECISION
  ! ==================
  subroutine prolong_masked_kernel_code_r_single( nlayers,                 &
                                                  cell_map,                &
    ...
    real(kind=r_single), dimension(undf_coarse),        intent(in)    :: field_coarse
    real(kind=r_single), dimension(undf_fine),          intent(inout) :: field_fine
  ...
  end subroutine prolong_masked_kernel_code_r_single

  ! R_DOUBLE PRECISION
  ! ==================
  subroutine prolong_masked_kernel_code_r_double( nlayers,                 &
                                                  cell_map,                &
                                                  ncell_fine_per_coarse_x, &
                                                  ncell_fine_per_coarse_y, &
                                                  ncell_fine,              &
    ...
    real(kind=r_double), dimension(undf_coarse),        intent(in)    :: field_coarse
    real(kind=r_double), dimension(undf_fine),          intent(inout) :: field_fine
  ...
  end subroutine prolong_masked_kernel_code_r_double
