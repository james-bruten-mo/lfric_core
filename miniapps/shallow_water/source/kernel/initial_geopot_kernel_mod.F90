...
!> @details Computes initial geopotential perturbation field from a given
!!          analytic expression.
module initial_geopot_kernel_mod
  ...
  contains
      procedure, nopass :: initial_geopot_code
  end type

  !-------------------------------------------------------------------------------
  ! Contained functions/subroutines
  !-------------------------------------------------------------------------------
  public initial_geopot_code
...
contains
  ...
  subroutine initial_geopot_code(nlayers, geopot, domain_x,     &
    ...
    ! compute the pointwise geopotential profile
    do df0 = 1, ndf_wx
  ...
  end subroutine initial_geopot_code

end module initial_geopot_kernel_mod
